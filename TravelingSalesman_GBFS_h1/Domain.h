//
//  Domain.h
//  TravelingSalesman_GBFS_h1
//
//  Created by Liza Girsova on 10/24/14.
//  Copyright (c) 2014 CMSC470. All rights reserved.
//

#ifndef __TravelingSalesman_GBFS_h1__Domain__
#define __TravelingSalesman_GBFS_h1__Domain__
...
public:
    ...
    int getHeuristic(T tempNode, S rootNode){
        ...
        int count = citiesVisited(tempNode, rootNode);
        int citiesLeft = totalCities - count;
        return citiesLeft;  // Returns how many cities we still have to visit
    }
...
#endif /* defined(__TravelingSalesman_GBFS_h1__Domain__) */
